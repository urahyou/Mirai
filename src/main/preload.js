...
contextBridge.exposeInMainWorld('desktopPet', Object.freeze({
  ...
  openSettingsCenter: () => ipcRenderer.invoke('settings:openCenter'),
  closeSettingsCenter: () => ipcRenderer.invoke('settings:closeCenter'),
  openAppearancePanel: () => ipcRenderer.invoke('appearance:open'),
  closeAppearancePanel: () => ipcRenderer.invoke('appearance:close'),
  openBehaviorPanel: () => ipcRenderer.invoke('behavior:open'),
  ...
  initiative: Object.freeze({
    ...
    set: (patch) => ipcRenderer.invoke('initiative:set', patch),
  }),
